...
using ERP.BuildingBlocks.EventBusRabbitMQ;
using ERP.BuildingBlocks.EventBusServiceBus;
    ...
    public static IServiceCollection AddEventBus(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        else
        {
            ...
            services.AddSingleton<IEventBus, EventBusRabbitMQ>(sp =>
            {
                ...
                return new EventBusRabbitMQ(rabbitMQPersistentConnection, logger, (ILifetimeScope)sp, eventBusSubscriptionsManager,
